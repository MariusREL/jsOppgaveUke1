...
// cannot do because a is a const 
// v
// a += 13
...
console.log("b = " + b);
console.log("d = " + d);
// d is an even number as it is divisible by two without a remainder
d %= 2
console.log(d);
/******************************************************************************
OPPGAVE 4
...
if (userName != "" && userAge >= 18 && userIsBlocked === false){
    userIsLoggedIn = true;
    goToPage = "/home";
    console.log("Welcome in, padawan");
} else {
    console.log("unfortunately, you aren't the jedi we're looking for");
}
